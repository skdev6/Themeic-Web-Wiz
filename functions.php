 ...
 */
function web_wiz_theme_setup() {
	/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on Web Wiz, use a find and replace
		* to change 'web-wiz' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'web-wiz', get_template_directory() . '/languages' );
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'web_wiz_custom_background_args',
			array(
...
add_action( 'after_setup_theme', 'web_wiz_theme_setup' );
 ...
 */
function web_wiz_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'web_wiz_content_width', 640 );
}
add_action( 'after_setup_theme', 'web_wiz_content_width', 0 );
